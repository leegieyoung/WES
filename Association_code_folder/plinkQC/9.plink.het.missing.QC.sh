...
${p2_Dir}/plink2 --pfile ${Output_dir}/${Sample}_g_m \
 ...
 --threads ${Thread} \
 --memory ${MEM} \
 --out ${Output_dir}/${Sample}_g_m_maf

rm -rf ${Output_dir}/${Sample}_g_m.pgen
rm -rf ${Output_dir}/${Sample}_g_m.psam
rm -rf ${Output_dir}/${Sample}_g_m.pvar

${p2_Dir}/plink2 --pfile ${Output_dir}/${Sample}_g_m_maf \
 --hwe 1e-6 \
 --make-pgen \
 --threads ${Thread} \
 --memory ${MEM} \
 --out ${Output_dir}/${Sample}_g_m_maf_hwe

echo ""
echo "===================Check heterozygosity========================"
echo ""

${p2_Dir}/plink2 --pfile ${Output_dir}/${Sample}_g_m_maf_hwe \
 --exclude ${Inversion} \
