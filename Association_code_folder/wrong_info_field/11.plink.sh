...
${p2_Dir}/plink2 --pfile ${Output_dir}/${Sample}_maf_hwe_het_pca \
 --double-id \
 --pca 10 \
 --extract ${Output_dir}/${Sample}_pca_indepSNP.prune.in \
 --threads ${Thread} \
 --out ${Output_dir}/${Sample}_maf_hwe_het_pca_PCA
...
${p2_Dir}/plink2 --pfile ${Output_dir}/${Sample} \
 ...
 --out ${Output_dir}/${Sample}_hwe_het_pca


#홍반
${p2_Dir}/plink2 --pfile ${Output_dir}/${Sample}_hwe_het_pca \
 --glm hide-covar \
 --memory ${MEM} \
