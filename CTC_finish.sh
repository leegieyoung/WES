...
mkdir -p ${REF_PATH}/snpEff
wget -P ${REF_PATH}/snpEff --no-check-certificate http://sourceforge.net/projects/snpeff/files/snpEff_latest_core.zip 
snpEff="/scratch/hpc46a05/REFERENCE/DNA/snpEff/snpEff"
...
echo "==========================="
echo "Complele GetPileupSummaries"
echo "==========================="
...
echo "================================"
echo "Complete Mutect2-tumor-only-mode"
echo "================================"
...
echo "================================="
echo " Complete CalculateContamination"
echo "================================="
...
echo "================================="
echo "    Complete FilterMutectCalls"
echo "================================="

#12-snpEff
mkdir ${path}/${sample}/12_${tumor}-MN
zcat  ${path}/${sample}/11_${tumor}-FilterMutectCalls-MN/${tumor}-filtermutectcalls.vcf.gz | grep '^#' > ${path}/${sample}/12_${tumor}-MN/head.vcf
zcat ${path}/${sample}/11_${tumor}-FilterMutectCalls-MN/${tumor}-filtermutectcalls.vcf.gz | grep 'PASS' | grep -v '^# '> ${path}/${sample}/12_${tumor}-MN/raw_PASS.vcf
cat ${path}/${sample}/12_${tumor}-MN/head.vcf ${path}/${sample}/12_${tumor}-MN/raw_PASS.vcf > ${path}/${sample}/12_${tumor}-MN/PASS.vcf
java -jar ${snpEff}/snpEff.jar GRCh37.75 ${path}/${sample}/12_${tumor}-MN/PASS.vcf > ${path}/${sample}/12_${tumor}-MN/${tumor}.vcf

echo "================================="
echo "        Complete snpEff"
echo "================================="
...
#12-snpEff
mkdir ${path}/${sample}/12_${tumor}-tumor-only
zcat  ${path}/${sample}/11_${tumor}-FilterMutectCalls-tumor-only/${tumor}-filtermutectcalls.vcf.gz | grep '^#' > ${path}/${sample}/11_${tumor}-FilterMutectCalls-tumor-only/head.vcf
zcat ${path}/${sample}/11_${tumor}-FilterMutectCalls-tumor-only/${tumor}-filtermutectcalls.vcf.gz | grep 'PASS' | grep -v '^# '> ${path}/${sample}/11_${tumor}-FilterMutectCalls-tumor-only/raw_PASS.vcf
cat ${path}/${sample}/11_${tumor}-FilterMutectCalls-tumor-only/head.vcf ${path}/${sample}/11_${tumor}-FilterMutectCalls-tumor-only/raw_PASS.vcf > ${path}/${sample}/12_${tumor}-tumor-only/PASS.vcf
java -jar ${snpEff}/snpEff.jar GRCh37.75 ${path}/${sample}/12_${tumor}-tumor-only/PASS.vcf > ${path}/${sample}/12_${tumor}-tumor-only/${tumor}.vcf
