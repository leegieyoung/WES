...
singularity exec --bind /ichrogene/:/ichrogene/ ${Singularity_Dir}/PRS.sif bcftools index --threads 32 ${Result_Dir}/temp/chr${A}_indels_filtered.PASS.snpEff.rsID.dbnsfp.vcf.gz
