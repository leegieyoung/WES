...
write.table(result ,"/ichrogene/project/temp/gylee/1.WES/2.gatk_result/total69/4.VariantFiltration/Find/dbNSFP.CADD.clinvar.refaltdepth.vcf.merge", col.names=T, row.names=F, sep='\t', quote=F)
