...
grep -e 'LEPR' -e 'DICER1' -e 'SFXN4' -e 'LYPM7' ${Result_Dir}/snps | grep -v '^#' > ${Result_Dir}/snps.temp
...
cat ${Result_Dir}/header ${Result_Dir}/snps.temp ${Result_Dir}/indels.temp >  ${Result_Dir}/snps.indels_filtered.Gene.PASS.snpEff.SnpSift.vcf
